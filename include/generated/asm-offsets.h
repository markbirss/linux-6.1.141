...
#define TSK_ACTIVE_MM 776 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 920 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2048 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3032 /* offsetof(struct task_struct, thread.sctlr_user) */
