...
static const struct regval mia1321_linear_120_1280x1080_regs1[] = {
	{0x011d,0x00},
	{0x011f,0x00},
	{0x012e,0x02},//{0x012e,0x00},
	{0x012b,0x01},//{0x012b,0x00},
	{0x00bd,0x00},
	{0x00bc,0x01},
	{0x00bf,0x00},
	{0x00c0,0x00},
				 ...
				 struct v4l2_mbus_config *config)
{
	...
	config->bus.mipi_csi2.num_data_lanes = MIA1321_LANES;
...
static void mia1321_remove(struct i2c_client *client)
{
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct mia1321 *mia1321 = to_mia1321(sd);
